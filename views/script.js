...
gameStates[2] = function(){
    ...
    console.log(highScoreElements.children);
    var highScoreChildren = highScoreElements.children;

    console.log(highScoreChildren[1].getAttribute('id'));
    highScoreChildren[1].value = score;
    console.log(highScoreChildren[1].value);
